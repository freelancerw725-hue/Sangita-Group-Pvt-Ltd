import {
  LayoutDashboard, Sparkles, CalendarClock, CheckSquare, Target, Activity,
  Users, GitBranch, Mail, MessageCircle, PhoneCall, Video, Calendar,
  Wallet, FileText, FileCheck2, FileSignature, PenTool,
  FolderKanban, UserCircle2, Brain, BarChart3, TrendingUp,
  Bell, Settings, Package,
  Rocket,
  type LucideIcon,
} from "lucide-react";
